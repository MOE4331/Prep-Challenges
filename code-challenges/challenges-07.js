...
const objLat = (obj) => {
    ...
    let nameCapital =Object.values(obj);
    let f_Name = nameCapital[0].charAt(0).toUpperCase() + nameCapital[0].slice(1);
    let l_Name = nameCapital[1].charAt(0).toUpperCase() + nameCapital[1].slice(1);
    let output = `my name is ${f_Name} ${l_Name} I am ${nameCapital[2]} YO, and I love ${nameCapital[3]}.`
    return output;
};
// -------------------------------------------------------------------------------------------------------
